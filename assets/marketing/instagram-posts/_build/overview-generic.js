...
function pointsList(points) {
  ...
  const row = (item) => `
    <div style="display:flex; align-items:flex-start; gap:16px; margin-bottom:34px;">
      ...
      <div style="font-family:'Inter',sans-serif; font-weight:700; font-size:28px; line-height:1.28; color:${t.headline}; text-align:left;">${item}</div>
    </div>`;
  if (!colB.length) {
...
const OVERVIEWS = [
  ...
  },
  {
    ...
    points: [
      ...
      "Eigene Validierung statt Drittanbieter-Tool",
      "Landet direkt und sicher in deinem Postfach",
    ],
