...
(() => {
  ...
  function boot(runtime, doc = document) {
    ...
    { /* patched: standalone hosting disables the self-refetch below — it races with componentDidMount DOM mutations (e.g. one-time mount animations) and force-rerenders over them. Harmless to skip once the page has already loaded its own markup. */ }
    const dc = doc.querySelector("x-dc");
